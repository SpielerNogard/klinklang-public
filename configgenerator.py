...
from klinklang_public.core.config_generation.database_config import (
    get_database_config,
    get_container_config_from_db_config,
)
from klinklang_public.core.config_generation.domain_config import get_domain_config
from klinklang_public.core.config_generation.mail_reader_config import (
    get_mail_reader_config,
    get_container_config_from_mail_reader,
)
from klinklang_public.core.config_generation.mail_server_config import (
    get_mail_server_config,
    get_container_config_from_mail_server,
)
from klinklang_public.core.config_generation.proxy_config import (
    get_proxy_config,
    get_container_config_from_proxy,
)
from klinklang_public.core.config_generation.queue_config import (
    get_container_config_from_queue_config,
    get_queue_config,
)
from klinklang_public.core.config_generation.exporter_config import (
    get_export_config,
    get_container_config_from_export,
)
...
CONFIGS = {
    "database": {
        "container": get_container_config_from_db_config,
        "config": get_database_config,
    },
    # "queue": {
    #     "config": get_queue_config,
    #     "container": get_container_config_from_queue_config,
    # },
    "mail_server": {
        "config": get_mail_server_config,
        "container": get_container_config_from_mail_server,
    },
    "mail_reader": {
        "config": get_mail_reader_config,
        "container": get_container_config_from_mail_reader,
    },
    "domains": {"config": get_domain_config},
    "proxies": {
        "config": get_proxy_config,
        "container": get_container_config_from_proxy,
    },
    "export": {
        "config": get_export_config,
        "container": get_container_config_from_export,
    },
}
